...
namespace WorkManagermentWeb.Infrastructure.Migrations
{
    ...
    [Migration("20240824085011_CalendarEventRel")]
    partial class CalendarEventRel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkManagermentWeb.Domain.Entities.CalendarEvent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WorkManagermentWeb.Domain.Entities.CalendarEvent", b =>
                {
                    b.HasOne("WorkManagermentWeb.Domain.Entities.WorkItem", "WorkItem")
                        ...
                        .HasForeignKey("WorkManagermentWeb.Domain.Entities.CalendarEvent", "WorkItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
